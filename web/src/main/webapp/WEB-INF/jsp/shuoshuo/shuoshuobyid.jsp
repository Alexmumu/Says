		...
		<div class="am-container">
			...
			<div class="am-u-lg-9  ">
				...
				<c:if test="${con.data.shuonature == 0 }">
					...
					<div class="am-g">
						...
						<div class="am-u-lg-9">
							<div class="am-g  block">
								...
								<div class="am-g am-text-xs">
									<a class="am-link-muted" href="user/myhome?userid=${p.data.userid.userid }" target="view_window"">${con.data.userid.username}
						...
						<div class="am-g am-text-sm">
							<div class="am-fr">
								<span>
									<button onclick="tanchuang('Comments/toCommentsaa?commentsforid=${con.data.shuoid}&userid.userid=${con.data.userid.userid}&type=1')"  class="am-link-muted"><i class="am-icon-comments"></i>评论 (${con.pinglunnum })</button>
								</span>
					<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
						<span>
						<button onclick="tanchuang('Relay/findall?type=1&useridare.userid=${con.data.userid.userid}&relayfrom=${con.contentfromid}')" class="am-link-muted" alt="转发">
				<i class="am-icon-share" alt="转发"></i>
				转发 (${con.zhuanfanum })</button>
								</span>
									<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
								<span>
									<button onclick="dianzan('${con.data.userid.userid}','${con.data.shuoid}',this)" class="am-link-muted"><i class="am-icon-thumbs-up"></i> ${con.dianzannum }</button>
								</span>
								<c:if test="${con.data.userid.userid==myuser.userid }">
								<span>
									<a  href="Shuoshuo/deleteshuoshuo?shuoid=${con.data.shuoid }" target="view_window"><i class="am-icon-trash am-icon-sm"></i></a>
								</span>
								</c:if>
							</div>
						</div>
					...
					<div class="am-g">
						...
						<div class="am-u-lg-9">
							<div class="am-g  block">
								...
								<!--日志的例子-->
								<div class="am-g am-text-xs">
									<a class="am-link-muted" href="user/myhome?userid=${p.data.userid.userid }" target="view_window">${con.data.userid.username}</a>
								...
								<div class="am-g am-text-sm">
									<a class="am-link-muted" href="user/myhome?userid=${p.fromid }" target="view_window"> <i class="am-icon-link">
									</i> ${con.fromname}∶
				...
				转发 (${con.zhuanfanum })</button>
								...
								<c:if test="${con.data.userid.userid==myuser.userid }">
								<span>
									<a  href="Shuoshuo/deleteshuoshuo?shuoid=${con.data.shuoid }"><i class="am-icon-trash am-icon-sm"></i></a>
								</span>
								</c:if>
							</div>
						</div>
