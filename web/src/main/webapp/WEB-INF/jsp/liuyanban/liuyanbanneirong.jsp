	...
	<div class="am-g" style="background: #fafafa; border:1px dashed #ededef;height:100px;">
		...
		<!--评论框-->
							<div class="am-g">
							 ...
							 <form id="fabiaoliuyan" action="Leavword/addSaysLeaveword"  method="post">
							     <div class="am-u-lg-12" style="height:100px;">
							    	...
							    	<input type="hidden" value="${fangwenUserid}" name="userid.userid"/>
							   		<input type="hidden" value="${myuser.userid}" name="fromuserid.userid"/>
...
<div class="am-panel-bd">
  ...
  <c:if test="${fangwenUserid==myuser.userid}"><a id="sanchu" onclick="javascript:window.parent.location.reload();" style="background-color:A2A2A2; font-size:14px; color:blue; margin-top: -118px ; float:right;" class="am-close am-close-alt am-close-spin" href="Leavword/deleteUserWord?leavewordid=${pro.leavewordid}">
  x
</a></c:if>
  </c:forEach>
  </ul>
